...
namespace AhmedDe\FilamentExtendedDate\Support\Constants;
...
class TZ
{
    ...
    public const AFRICA_PORTONOVO = 'Africa/Porto-Novo';
    ...
    public const AMERICA_BLANCSABLON = 'America/Blanc-Sablon';
    ...
    public const AMERICA_NORTH_DAKOTA_NEWSALEM = 'America/North_Dakota/New_Salem';
    ...
    public const AMERICA_PORTAUPRINCE = 'America/Port-au-Prince';
    ...
    public const AMERICA_RANK_ININLET = 'America/Rankin_Inlet';
    ...
    public const ASIA_USTNERA = 'Asia/Ust-Nera';
